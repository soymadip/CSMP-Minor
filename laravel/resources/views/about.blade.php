...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
  ...
  >
    ...
    <main
      class="flex-1 overflow-y-auto transition-all duration-700 starting:opacity-0 starting:translate-y-5"
    >
      ...
      <section class="py-20 relative overflow-hidden border-b border-white/10">
        ...
        ></div>
        <div
          class="absolute inset-0 z-10 bg-linear-to-b from-black/80 via-black/90 to-black/95 backdrop-blur-[2px]"
        ></div>
          ...
          >
            <p class="drop-shadow-md">
              <span class="text-rose-500 font-extrabold"
                >The Calcutta Technical School</span
              >
              is one of the most prestigious and oldest technical institutions
              in West Bengal. Established in
              <span
                class="text-white font-bold underline decoration-primary/50 underline-offset-4"
                >1927</span
              >, before India's independence, it began with need-based technical
            ...
            <p class="drop-shadow-md">
              ...
              <span class="text-rose-500 font-extrabold italic"
                >heritage symbol</span
              >
      ...
      >
        <div class="container mx-auto px-4 max-w-6xl">
          <h2
            class="text-4xl font-bold text-center text-red-500 mb-12 drop-shadow-md outline-hidden"
          >
            Institutional
            <span
              class="text-slate-900 in-[.dark]:text-white italic underline decoration-rose-500 decoration-4 underline-offset-8 transition-all hover:underline-offset-4"
              >Gallery</span
            >
          </h2>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[200px]">
            ...
            >
              ...
              >
                <span
                  class="text-white font-medium border-b-2 border-rose-500 pb-1"
                  >Excellence in Technical Education</span
                >
              </div>
            </div>
          ...
          <div class="text-center mt-12">
            <a
              href="#"
              class="inline-flex items-center px-8 py-3 rounded-2xl border-2 border-rose-500 text-rose-500 hover:bg-rose-500 hover:text-white transition-all hover:scale-105 font-bold"
            >
      ...
      >
        <div class="container mx-auto px-4 max-w-6xl">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <!-- Left: Map -->
            <div
              class="w-full h-[400px] rounded-2xl overflow-hidden border-2 border-slate-200 in-[.dark]:border-white/10 shadow-2xl group"
            >
              <iframe
