<div class="p-6 bg-white dark:bg-gray-800 shadow-lg rounded-2xl-lg">
	...
	<form wire:submit.prevent="addRegistration">
		...
		<button type="submit" class="mt-2 bg-rose-500 text-white p-2 rounded-2xl">Add</button>
	</form>
	...
	<ul class="mt-2 space-y-2">
		...
		<li class="p-2 bg-gray-100 dark:bg-gray-700 rounded-2xl">{{ $student->registration_no }}</li>
		@endforeach
	</ul>
</div>
